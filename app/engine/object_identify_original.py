...
from words import find_representative_words


def analyze_resnet(image_path):
...
def analyze_densenet(image_path):
...
def tag_whole_object(image_path, network='RESNET'):
...
print(tag_whole_object('cups.jpg'))
print(tag_whole_object('cups.jpg', network='DENSENET'))
